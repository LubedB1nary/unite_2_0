    ...
    <div style={{ background: D.paper, fontFamily: D.sans, color: D.ink, minHeight: '100vh' }}>
      ...
      <main id="main">
        ...
        <section style={{ padding: '24px 40px 64px' }}>
          <div style={{ maxWidth: 1360, margin: '0 auto', display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 56, alignItems: 'start' }}>
            <PhotoPlaceholder caption="Damon Reed, Lithia Springs warehouse" height={520} stripeFrom="#e8ddcd" stripeTo="#d9c8b0" textColor={D.plum} />
            <div>
              <div style={{ fontFamily: D.mono, fontSize: 11, letterSpacing: 1.4, color: D.plum }}>FOUNDER · DAMON REED</div>
              <h2 style={{ fontFamily: D.display, fontSize: 48, fontWeight: 400, letterSpacing: -1, lineHeight: 1.05, margin: '14px 0 18px' }}>22 years moving supplies. Now I do it for medicine.</h2>
        ...
        <section style={{ background: D.paperAlt, padding: '96px 40px', borderTop: `1px solid ${D.line}`, borderBottom: `1px solid ${D.line}` }}>
          <div style={{ maxWidth: 1360, margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: D.display, fontSize: 56, fontWeight: 400, letterSpacing: -1.2, lineHeight: 1, margin: 0 }}>Three pillars. <Grad>No theatre.</Grad></h2>
        ...
        <section style={{ padding: '96px 40px', background: D.plum, color: D.paper }}>
          <div style={{ maxWidth: 1360, margin: '0 auto', display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 56, alignItems: 'center' }}>
