    ...
    <div style={{ background: D.paper, fontFamily: D.sans, color: D.ink, minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 1360, margin: '0 auto', padding: '32px 40px 80px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: 32 }}>
          <div>
            <div style={{ fontFamily: D.display, fontSize: 48, letterSpacing: -1, lineHeight: 1.05 }}>How dealers use us.</div>
            <div style={{ marginTop: 20, display: 'grid', gap: 12 }}>
              {[
                ...
                <div key={i} style={{ padding: 22, background: D.card, borderRadius: 12, border: `1px solid ${D.line}`, display: 'grid', gridTemplateColumns: '140px 1fr', gap: 24 }}>
          ...
          <div>
            <div style={{ padding: 28, background: D.ink, color: D.paper, borderRadius: 16 }}>
